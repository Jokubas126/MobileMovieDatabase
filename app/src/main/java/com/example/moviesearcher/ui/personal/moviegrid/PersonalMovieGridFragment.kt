...
class PersonalMovieGridFragment : Fragment(), GridAdapter.AdapterItemClickListener {

    private lateinit var viewModel: PersonalMovieGridViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel = ViewModelProvider(this).get(PersonalMovieGridViewModel::class.java)
