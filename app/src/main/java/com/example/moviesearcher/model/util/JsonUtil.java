...
public class JsonUtil {
    ...
    public String getPeopleUrl(int id){ return BASE_MOVIE_DETAILS + id + "/credits?api_key=" + API_KEY; }
    ...
    public String getProfileImageUrl(String imagePath){ return BASE_PROFILE_IMAGE_URL + imagePath; }
